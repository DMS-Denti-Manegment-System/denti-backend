                ...
                <tbody class="text-gray-600 fw-semibold">
                    @forelse($categories as $category)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('categories.edit', $category) }}" class="btn btn-sm btn-light-primary" data-module-edit>Duzenle</a>
                                <form method="POST" action="{{ route('categories.destroy', $category) }}" class="d-inline" onsubmit="return confirm('Kategori kalici silinsin mi?')">
                                    @csrf
                                    @method('DELETE')
