...
class Container_7a5e8b5f8c extends _PHPStan_8c66d8255\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_7a5e8b5f8c $container)
			{
	...
	public function createServiceContainer(): Container_7a5e8b5f8c
	{
		return $this;
	}
