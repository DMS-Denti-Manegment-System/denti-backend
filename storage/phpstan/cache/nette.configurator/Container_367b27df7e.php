...
class Container_367b27df7e extends _PHPStan_8c66d8255\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService051(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			...
			[
				...
				[
					'message' => '#^Call to an undefined method Illuminate\\\Contracts\\\View\\\View\:\:withErrors\(\)\.$#',
					'count' => 1,
					'path' => '/Users/emircanuysal/Desktop/denti-backend/app/Http/Controllers/Web/OperationsPageController.php',
				],
				[
				...
				[
					'message' => '#^Call to an undefined method Illuminate\\\Contracts\\\Auth\\\Factory\:\:id\(\)\.$#',
					'count' => 1,
					'path' => '/Users/emircanuysal/Desktop/denti-backend/app/Http/Middleware/RequestContextMiddleware.php',
				],
				[
					'message' => '#^Call to an undefined method Illuminate\\\Contracts\\\Auth\\\Factory\:\:user\(\)\.$#',
					'count' => 1,
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_367b27df7e $container)
			{
	...
	public function createServiceContainer(): Container_367b27df7e
	{
		return $this;
	}
