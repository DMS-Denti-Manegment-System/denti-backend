...
class Container_897b24f50f extends _PHPStan_8c66d8255\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_897b24f50f $container)
			{
	...
	public function createServiceContainer(): Container_897b24f50f
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'generateBaselineFile' => '/Users/emircanuysal/Desktop/denti-backend/phpstan-baseline.neon',
			'usedLevel' => '5',
