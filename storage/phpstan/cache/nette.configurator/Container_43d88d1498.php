...
class Container_43d88d1498 extends _PHPStan_8c66d8255\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_43d88d1498 $container)
			{
	...
	public function createServiceContainer(): Container_43d88d1498
	{
		return $this;
	}
