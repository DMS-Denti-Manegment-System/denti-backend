...
class Container_16bc3649c9 extends _PHPStan_8c66d8255\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_16bc3649c9 $container)
			{
	...
	public function createServiceContainer(): Container_16bc3649c9
	{
		return $this;
	}
