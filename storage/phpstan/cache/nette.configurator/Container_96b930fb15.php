...
class Container_96b930fb15 extends _PHPStan_8c66d8255\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_96b930fb15 $container)
			{
	...
	public function createServiceContainer(): Container_96b930fb15
	{
		return $this;
	}
